...
lsm_LOOP_f = function(parms_row,village,nets_use,root_eir){
  ...
  simparams <- bednetparams_1 |>
    set_carrying_capacity(
      carrying_capacity = t(matrix(c(cc * c(phi_lsm_gam[village]*0.5,
                                            phi_lsm_fun[village]*0.5)),nrow = 2)),
...
write.csv(range_est1,"carrying_cap_model_outputs_village1_with50pc_reduction_globally.csv")
write.csv(range_est2,"carrying_cap_model_outputs_village2_with50pc_reduction_globally.csv")
write.csv(range_est3,"carrying_cap_model_outputs_village3_with50pc_reduction_globally.csv")
write.csv(range_est4,"carrying_cap_model_outputs_village4_with50pc_reduction_globally.csv")
write.csv(range_est5,"carrying_cap_model_outputs_village5_with50pc_reduction_globally.csv")
write.csv(range_est6,"carrying_cap_model_outputs_village6_with50pc_reduction_globally.csv")
...
##
#####################################################
range_est1 = read.csv("R/malariasimulation/model outputs/carrying_cap_model_outputs_village1_with50pc_reduction_globally.csv")[,2:5]
range_est2 = read.csv("R/malariasimulation/model outputs/carrying_cap_model_outputs_village2_with50pc_reduction_globally.csv")[,2:5]
range_est3 = read.csv("R/malariasimulation/model outputs/carrying_cap_model_outputs_village3_with50pc_reduction_globally.csv")[,2:5]
range_est4 = read.csv("R/malariasimulation/model outputs/carrying_cap_model_outputs_village4_with50pc_reduction_globally.csv")[,2:5]
range_est5 = read.csv("R/malariasimulation/model outputs/carrying_cap_model_outputs_village5_with50pc_reduction_globally.csv")[,2:5]
range_est6 = read.csv("R/malariasimulation/model outputs/carrying_cap_model_outputs_village6_with50pc_reduction_globally.csv")[,2:5]
