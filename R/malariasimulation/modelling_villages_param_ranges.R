...
write.csv(range_est1,"model_outputs_village1.csv")
write.csv(range_est2,"model_outputs_village2.csv")
write.csv(range_est3,"model_outputs_village3.csv")
write.csv(range_est4,"model_outputs_village4.csv")
write.csv(range_est5,"model_outputs_village5.csv")
