...
nets = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/data/Kenya/net_use.csv",header=TRUE)

## add prevalence data
data_people = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/data/Kenya/Fillinger_Kenya highland LSM_MALARIA SURVEY DATA.csv",header=TRUE) 
...
## input params
parms = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/R/malariasimulation/params_lsm_range.csv",header=TRUE)
...
lsm_LOOP_f = function(parms_row,village,nets_use,root_eir){
  ...
  simparams <- bednetparams_1 |>
    set_carrying_capacity(
      carrying_capacity = t(matrix(c(1,1),nrow = 2)),
  ...
  output_net1$pv_182.5_3650 = output_net1$n_detect_lm_182.5_3650/output_net1$n_age_182.5_3650
...
write.csv(counterf1,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/counterf1.csv")
write.csv(counterf2,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/counterf2.csv")
write.csv(counterf3,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/counterf3.csv")
write.csv(counterf4,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/counterf4.csv")
write.csv(counterf5,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/counterf5.csv")
write.csv(counterf6,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/counterf6.csv")
...
lsm_LOOP_f = function(parms_row,village,nets_use,root_eir,lsm_uncertainty){
  ...
  simparams <- bednetparams_1 |>
    set_carrying_capacity(
      carrying_capacity = t(matrix(c(phi_lsm_gamA[village,lsm_uncertainty],
  ...
  return(data.frame(timestep = output_net1$timestep,
                    net_use = output_net1$n_use_net/human_population,
                    prev_6m_10y = output_net1$pv_182.5_3650,
                    ccgam = output_net1$total_M_gambiae.sl,
                    ccfun = output_net1$total_M_funestus.sl) )
  
}

phi_lsm_gamA = data.frame(village = 1:6,
                          lsm_mean = 1 - c(97.09572, 0, 78.59411, 47.19454,  0, 0)/100,
                          lsm_min =  1 - c(91.45203, 0, 45.98200, -51.69513, 0, 0)/100,
                          lsm_max =  1 - c(99.08610, 0, 91.35014, 82.31228,  0, 0)/100)
phi_lsm_funA = data.frame(village = 1:6,
                          lsm_mean = 1 - c(87.33452, 0, 61.850261, 13.314484, 0, 0)/100,
                          lsm_min =  1 - c(28.58144, 0, -8.487684,  7.308125, 0, 0)/100,
                          lsm_max =  1 - c(98.86324, 0, 86.149896, 20.917409, 0, 0)/100)

lsm_LOOP_f(parms_row = 1,
           village = 1,
           nets_use = nets_use1, 
           root_eir = 117.8074,
           lsm_uncertainty=2)
...
for(i in 1:nrow(parms)){
  v1[[i]] = lsm_LOOP_f(parms_row = i,
                       village = 1,
                       nets_use = nets_use1, 
                       root_eir = 117.8074,
                       lsm_uncertainty=2) ## MEAN
  v1L[[i]] = lsm_LOOP_f(parms_row = i,
                        village = 1,
                        nets_use = nets_use1, 
                        root_eir = 117.8074,
                        lsm_uncertainty=3) ## MIN
  v1U[[i]] = lsm_LOOP_f(parms_row = i,
                        village = 1,
                        nets_use = nets_use1, 
                        root_eir = 117.8074,
                        lsm_uncertainty=4) ## MAX
...
for(i in 1:nrow(parms)){
  v2[[i]] = lsm_LOOP_f(parms_row = i,village = 2,nets_use = nets_use2, root_eir = 90.2171,lsm_uncertainty=2)
  v3[[i]] = lsm_LOOP_f(parms_row = i,village = 3,nets_use = nets_use3, root_eir = 75.2647,lsm_uncertainty=2)
  v4[[i]] = lsm_LOOP_f(parms_row = i,village = 4,nets_use = nets_use4, root_eir = 10.84384,lsm_uncertainty=2)
  v5[[i]] = lsm_LOOP_f(parms_row = i,village = 5,nets_use = nets_use5, root_eir = 34.12402,lsm_uncertainty=2)
  v6[[i]] = lsm_LOOP_f(parms_row = i,village = 6,nets_use = nets_use6, root_eir = 22.7,lsm_uncertainty=2)
  
  # v2L[[i]] = lsm_LOOP_f(parms_row = i,village = 2,nets_use = nets_use2, root_eir = 90.2171,lsm_uncertainty=2)
  v3L[[i]] = lsm_LOOP_f(parms_row = i,village = 3,nets_use = nets_use3, root_eir = 75.2647,lsm_uncertainty=3)
  v4L[[i]] = lsm_LOOP_f(parms_row = i,village = 4,nets_use = nets_use4, root_eir = 10.84384,lsm_uncertainty=3)
  ...
  v3U[[i]] = lsm_LOOP_f(parms_row = i,village = 3,nets_use = nets_use3, root_eir = 75.2647,lsm_uncertainty=4)
  v4U[[i]] = lsm_LOOP_f(parms_row = i,village = 4,nets_use = nets_use4, root_eir = 10.84384,lsm_uncertainty=4)
...
uncertainty_absolute_num_mos1 = 
  uncertainty_absolute_num_mos3 = 
  uncertainty_absolute_num_mos4 = array(data = NA,dim = c(81,6))
for(i in 1:81){
  uncertainty_absolute_num_mos1[i,1] = mean(v1[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v1[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos1[i,2] = mean(v1L[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v1L[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos1[i,3] = mean(v1U[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v1U[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])

  uncertainty_absolute_num_mos1[i,4] = mean(v1[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v1[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos1[i,5] = mean(v1L[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v1L[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos1[i,6] = mean(v1U[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v1U[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  
  uncertainty_absolute_num_mos3[i,1] = mean(v3[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v3[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos3[i,2] = mean(v3L[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v3L[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos3[i,3] = mean(v3U[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v3U[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  
  uncertainty_absolute_num_mos3[i,4] = mean(v3[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v3[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos3[i,5] = mean(v3L[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v3L[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos3[i,6] = mean(v3U[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v3U[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])

  uncertainty_absolute_num_mos4[i,1] = mean(v4[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v4[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos4[i,2] = mean(v4L[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v4L[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos4[i,3] = mean(v4U[[i]]$ccgam[c(2*year + 190):c(3*year + 190)]) - mean(v4U[[i]]$ccgam[c(3*year + 190):c(4*year + 190)])
  
  uncertainty_absolute_num_mos4[i,4] = mean(v4[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v4[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos4[i,5] = mean(v4L[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v4L[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
  uncertainty_absolute_num_mos4[i,6] = mean(v4U[[i]]$ccfun[c(2*year + 190):c(3*year + 190)]) - mean(v4U[[i]]$ccfun[c(3*year + 190):c(4*year + 190)])
}
quantile(uncertainty_absolute_num_mos1[,1:3],c(0.05,0.5,0.95))/10000
...
quantile(uncertainty_absolute_num_mos1[,4:6],c(0.05,0.5,0.95))/10000
...
##MEDIANS
range_estimates_v1 = array(data=NA, dim=c(nrow(v1[[1]]),3*81) )
range_estimates_v2 = array(data=NA, dim=c(nrow(v2[[1]]),3*81) )
range_estimates_v3 = array(data=NA, dim=c(nrow(v3[[1]]),3*81) )
range_estimates_v4 = array(data=NA, dim=c(nrow(v4[[1]]),3*81) )
range_estimates_v5 = array(data=NA, dim=c(nrow(v5[[1]]),3*81) )
range_estimates_v6 = array(data=NA, dim=c(nrow(v6[[1]]),3*81) )
for(i in 1:81){
  range_estimates_v1[,i] =    v1[[i]]$prev_6m_10y
  range_estimates_v1[,i+81] = v1L[[i]]$prev_6m_10y
  range_estimates_v1[,i+162] =v1U[[i]]$prev_6m_10y
  range_estimates_v2[,i] =    v2[[i]]$prev_6m_10y
  range_estimates_v2[,i+81] = v2[[i]]$prev_6m_10y
  range_estimates_v2[,i+162] =v2[[i]]$prev_6m_10y
  range_estimates_v3[,i] =    v3[[i]]$prev_6m_10y
  range_estimates_v3[,i+81] = v3L[[i]]$prev_6m_10y
  range_estimates_v3[,i+162] =v3U[[i]]$prev_6m_10y
  range_estimates_v4[,i] =    v4[[i]]$prev_6m_10y
  range_estimates_v4[,i+81] = v4L[[i]]$prev_6m_10y
  range_estimates_v4[,i+162] =v4U[[i]]$prev_6m_10y
  
  range_estimates_v5[,i] =    v5[[i]]$prev_6m_10y
  range_estimates_v5[,i+81] = v5[[i]]$prev_6m_10y
  range_estimates_v5[,i+162] =v5[[i]]$prev_6m_10y
  
  range_estimates_v6[,i] =    v6[[i]]$prev_6m_10y
  range_estimates_v6[,i+81] = v6[[i]]$prev_6m_10y
  range_estimates_v6[,i+162] =v6[[i]]$prev_6m_10y
}
...
write.csv(range_est1,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village1.csv")
write.csv(range_est2,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village2.csv")
write.csv(range_est3,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village3.csv")
write.csv(range_est4,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village4.csv")
write.csv(range_est5,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village5.csv")
write.csv(range_est6,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village6.csv")

write.csv(range_estimates_v1,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village1PREVS.csv")
write.csv(range_estimates_v2,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village2PREVS.csv")
write.csv(range_estimates_v3,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village3PREVS.csv")
write.csv(range_estimates_v4,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village4PREVS.csv")
write.csv(range_estimates_v5,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village5PREVS.csv")
write.csv(range_estimates_v6,"C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village6PREVS.csv")
...
##
## Reload data
range_est1 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village1.csv",header=TRUE)
range_est2 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village2.csv",header=TRUE)
range_est3 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village3.csv",header=TRUE)
range_est4 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village4.csv",header=TRUE)
range_est5 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village5.csv",header=TRUE)
range_est6 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/village6.csv",header=TRUE)

range_est1 = range_est1[,2:5]
range_est2 = range_est2[,2:5]
range_est3 = range_est3[,2:5]
range_est4 = range_est4[,2:5]
range_est5 = range_est5[,2:5]
range_est6 = range_est6[,2:5]

counterf1 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/Kenya/counterf1.csv",header=TRUE)
counterf2 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/Kenya/counterf2.csv",header=TRUE)
counterf3 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/Kenya/counterf3.csv",header=TRUE)
counterf4 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/Kenya/counterf4.csv",header=TRUE)
counterf5 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/Kenya/counterf5.csv",header=TRUE)
counterf6 = read.csv("C:/Users/esherrar/OneDrive - LSTM/ICL transfer documents/OneDrive_1_22-09-2024/Documents/lsm/CRITICAL R CODE/model outputs/Kenya/counterf6.csv",header=TRUE)
####################################
##
## Data from trial
...
plot(range_est1[,2] ~ range_est1[,1],
     ...
     xlab="",pch="",col="darkorange",
     xlim = c(2*year,5*year+30),
     xaxt="n",bty="n")
axis(1,at = c(2,3,4,5)*year,labels = c("Jan 2003","Jan 2004","Jan 2005","Jan 2006"))
...
polygon(c(range_est1[,1],rev(range_est1[,1])),
        ...
        col=adegenet::transp("darkorange",0.4),border=NA)
lines(counterf1$prev_6m_10y ~ counterf1$timestep,col="grey40",lwd=2)
lines(range_est1[,2] ~ range_est1[,1],col="darkorange",pch=1.5)
...
polygon(c(range_est3[,1],rev(range_est3[,1])),
        ...
        col=adegenet::transp("red",0.4),border=NA)
lines(counterf3$prev_6m_10y ~ counterf3$timestep,col="grey40",lwd=2)
lines(range_est3[,2] ~ range_est3[,1],col="red",pch=1.5)
...
plot(range_est4[,2] ~ range_est4[,1],
     main = "Wamondo",
     ylab="Prevalence 6-months to 10-years (%)", yaxt="n",ylim = c(0,1),
     xlab="",pch="",col="darkred",
     xlim = c(2*year,5*year+30),
     xaxt="n",bty="n")
axis(1,at = c(2,3,4,5)*year,labels = c("Jan 2003","Jan 2004","Jan 2005","Jan 2006"))
axis(2,las=2,at=seq(0,1,0.2),labels=seq(0,100,20))
abline(v = 3*year + 190,lty=2)
lines(v4L[[1]]$prev_6m_10y ~ v4L[[1]]$timestep)
polygon(c(range_est4[,1],rev(range_est4[,1])),
        c(range_est4[,3],rev(range_est4[,4])),
        col=adegenet::transp("darkred",0.4),border=NA)
lines(counterf4$prev_6m_10y ~ counterf4$timestep,col="grey40",lwd=2)
lines(range_est4[,2] ~ range_est3[,1],col="darkred",pch=1.5)
...
##############################################################
##
## Add in the efficacy comparison plot here
##
##
...
plot(sites1[19:48]~prev_cr_sect_mod[19:48,1],pch=19,col="darkorange",
     ...
     ylab="Reported prevalence 0.5 to 10-years (%)",
     xlab="Simulated prevalence 0.5 to 10-years (%)")
...
lines(range_est2[,2] ~ range_est2[,1],col="lightblue",pch=1.5)
...
points(sites2 ~ align_timeline, 
       cex = sqrt(numsites2)/5, col="lightblue",pch=19)

plot(range_est5[,2] ~ range_est5[,1],
     main = "Emutete",
     ylab="Prevalence 6-months to 10-years (%)", yaxt="n",ylim = c(0,1),
     xlab="",pch="",col="blue",
     xlim = c(2*year,5*year+30),xaxt="n",bty="n")
axis(1,at = c(2,3,4,5)*year,labels = c("Jan 2003","Jan 2004","Jan 2005","Jan 2006"))
...
lines(range_est5[,2] ~ range_est3[,1],col="blue",pch=1.5)
...
polygon(c(range_est6[,1],rev(range_est6[,1])),
        ...
        col=adegenet::transp("darkblue",0.4),border=NA)
...
vill1_difference = vill2_difference = 
  ...
  vill5_difference = array(data=NA,dim=c(81*3,6))
...
vill6_difference = array(data=NA,dim=c(81*3,6))
...
plot(vill1_difference[,1] ~ sample(seq(0.8,1.2,length=80),size=81*3,replace=TRUE),
...
mtext("Absolute difference in observed versus",line = 3.2,cex=0.75,side = 2)
mtext("simulated prevalence estimate",line=2.2,cex=0.75,side = 2)
points(vill2_difference[,1] ~ sample(seq(2-0.2,2+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("lightblue",0.5),pch=19)  

points(vill3_difference[,1] ~ sample(seq(3-0.2,3+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("red",0.5),pch=19)  

points(vill4_difference[,1] ~ sample(seq(4-0.2,4+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkred",0.5),pch=19)  

points(vill5_difference[,1] ~ sample(seq(5-0.2,5+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("blue",0.5),pch=19)  


## timestep 2
points(vill1_difference[,2] ~ sample(seq(7-0.2,7+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkorange",0.3),pch=19)  

points(vill2_difference[,2] ~ sample(seq(8-0.2,8+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("lightblue",0.5),pch=19)  

points(vill3_difference[,2] ~ sample(seq(9-0.2,9+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("red",0.5),pch=19)  

points(vill4_difference[,2] ~ sample(seq(10-0.2,10+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkred",0.5),pch=19)  

points(vill5_difference[,2] ~ sample(seq(11-0.2,11+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("blue",0.5),pch=19)  

points(vill6_difference[,1] ~ sample(seq(12-0.2,12+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkblue",0.5),pch=19)  


## timestep 3 apr 2006
points(vill1_difference[,3] ~ sample(seq(14-0.2,14+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkorange",0.3),pch=19)  

points(vill2_difference[,3] ~ sample(seq(15-0.2,15+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("lightblue",0.5),pch=19)  

points(vill3_difference[,3] ~ sample(seq(16-0.2,16+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("red",0.5),pch=19)  

points(vill4_difference[,3] ~ sample(seq(17-0.2,17+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkred",0.5),pch=19)  

points(vill5_difference[,3] ~ sample(seq(18-0.2,18+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("blue",0.5),pch=19)  

points(vill6_difference[,2] ~ sample(seq(19-0.2,19+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkblue",0.5),pch=19)  

## timestep 4 jul 2006
points(vill1_difference[,4] ~ sample(seq(21-0.2,21+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkorange",0.3),pch=19)  

points(vill2_difference[,4] ~ sample(seq(22-0.2,22+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("lightblue",0.5),pch=19)  

points(vill3_difference[,4] ~ sample(seq(23-0.2,23+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("red",0.5),pch=19)  

points(vill4_difference[,4] ~ sample(seq(24-0.2,24+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkred",0.5),pch=19)  

points(vill5_difference[,4] ~ sample(seq(25-0.2,25+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("blue",0.5),pch=19)  

points(vill6_difference[,3] ~ sample(seq(26-0.2,26+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkblue",0.5),pch=19)  


## timestep 5 jul 2006
points(vill1_difference[,5] ~ sample(seq(28-0.2,28+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkorange",0.3),pch=19)  

points(vill2_difference[,5] ~ sample(seq(29-0.2,29+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("lightblue",0.5),pch=19)  

points(vill3_difference[,5] ~ sample(seq(30-0.2,30+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("red",0.5),pch=19)  

points(vill4_difference[,5] ~ sample(seq(31-0.2,31+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkred",0.5),pch=19)  

points(vill5_difference[,5] ~ sample(seq(32-0.2,32+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("blue",0.5),pch=19)  

points(vill6_difference[,4] ~ sample(seq(33-0.2,33+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkblue",0.5),pch=19)  


## timestep 5 jul 2006
points(vill1_difference[,6] ~ sample(seq(35-0.2,35+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkorange",0.3),pch=19)  

points(vill2_difference[,6] ~ sample(seq(36-0.2,36+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("lightblue",0.5),pch=19)  

points(vill3_difference[,6] ~ sample(seq(37-0.2,37+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("red",0.5),pch=19)  

points(vill4_difference[,6] ~ sample(seq(38-0.2,38+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkred",0.5),pch=19)  

points(vill5_difference[,6] ~ sample(seq(39-0.2,39+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("blue",0.5),pch=19)  

points(vill6_difference[,5] ~ sample(seq(40-0.2,40+0.2,length=80),size=81*3,replace=TRUE),
       cex=0.5,col=adegenet::transp("darkblue",0.5),pch=19)  
...
text(x = -182, y = 2.08,"(A)",cex=0.8)
text(x = -130, y = 2.08,"(B)",cex=0.8)
text(x = -72, y = 2.08,"(C)",cex=0.8)
text(x = -5, y = 2.08,"(D)",cex=0.8)
text(x = -182, y = 0.65,"(E)",cex=0.8)
text(x = -130, y = 0.65,"(F)",cex=0.8)
text(x = -72, y = 0.65,"(G)",cex=0.8)
text(x = -5, y = 0.65,"(H)",cex=0.8)
...
# ## EFFICACY in treatment villages
# musilongo = 100*(counterf1$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#        range_est1[,2][SITES1_binomial_conf$align_timeline[7:12]])/counterf1$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# musilongoU = 100*(counterf1$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                    range_est1[,3][SITES1_binomial_conf$align_timeline[7:12]])/counterf1$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# musilongoL = 100*(counterf1$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est1[,4][SITES1_binomial_conf$align_timeline[7:12]])/counterf1$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# 
# Kimingini = 100*(counterf2$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                    range_est2[,2][SITES1_binomial_conf$align_timeline[7:12]])/counterf2$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# KiminginiU = 100*(counterf2$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est2[,3][SITES1_binomial_conf$align_timeline[7:12]])/counterf2$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# KiminginiL = 100*(counterf2$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est2[,4][SITES1_binomial_conf$align_timeline[7:12]])/counterf2$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# 
# Kezege = 100*(counterf3$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                    range_est3[,2][SITES1_binomial_conf$align_timeline[7:12]])/counterf3$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# KezegeU = 100*(counterf3$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                 range_est3[,3][SITES1_binomial_conf$align_timeline[7:12]])/counterf3$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# KezegeL = 100*(counterf3$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                 range_est3[,4][SITES1_binomial_conf$align_timeline[7:12]])/counterf3$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# 
# Wamondo = 100*(counterf4$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                    range_est4[,2][SITES1_binomial_conf$align_timeline[7:12]])/counterf4$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# WamondoU = 100*(counterf4$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                  range_est4[,3][SITES1_binomial_conf$align_timeline[7:12]])/counterf4$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# WamondoL = 100*(counterf4$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                  range_est4[,4][SITES1_binomial_conf$align_timeline[7:12]])/counterf4$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# 
# Emutete = 100*(counterf5$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                    range_est5[,2][SITES1_binomial_conf$align_timeline[7:12]])/counterf5$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# EmuteteU = 100*(counterf5$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est5[,3][SITES1_binomial_conf$align_timeline[7:12]])/counterf5$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# EmuteteL = 100*(counterf5$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est5[,4][SITES1_binomial_conf$align_timeline[7:12]])/counterf5$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# 
# Wakikuyu = 100*(counterf6$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                    range_est6[,2][SITES1_binomial_conf$align_timeline[7:12]])/counterf6$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# WakikuyuU = 100*(counterf6$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est6[,3][SITES1_binomial_conf$align_timeline[7:12]])/counterf6$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# WakikuyuL = 100*(counterf6$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]-
#                     range_est6[,4][SITES1_binomial_conf$align_timeline[7:12]])/counterf6$prev_6m_10y[SITES1_binomial_conf$align_timeline[1:6]]
# 
# 
# 
# sites1clean = sites1[complete.cases(sites1) == TRUE]
# sites2clean = sites2[complete.cases(sites2) == TRUE]
# sites3clean = sites3[complete.cases(sites3) == TRUE]
# sites4clean = sites4[complete.cases(sites4) == TRUE]
# sites5clean = sites5[complete.cases(sites5) == TRUE]
# sites6clean = sites6[complete.cases(sites6) == TRUE]
# 
# sites1_efficacy = 100*(sites1clean[1:6]-sites1clean[7:12])/sites1clean[1:6] 
# sites2_efficacy = 100*(sites2clean[1:6]-sites2clean[7:12])/sites2clean[1:6] 
# sites3_efficacy = 100*(sites3clean[1:6]-sites3clean[7:12])/sites3clean[1:6] 
# sites4_efficacy = 100*(sites4clean[1:6]-sites4clean[7:12])/sites4clean[1:6] 
# sites5_efficacy = 100*(sites5clean[1:6]-sites5clean[7:12])/sites5clean[1:6] 
# sites6_efficacy = 100*(sites6clean[1:6]-sites6clean[7:12])/sites6clean[1:6] 
# 
# trial_efficacy = c(sites1_efficacy,
#                    sites2_efficacy,
#                    sites3_efficacy,
#                    sites4_efficacy,
#                    sites5_efficacy,
...
#                       Wakikuyu)
# 
# modelled_efficacyU = c(musilongoU,KiminginiU,KezegeU,WamondoU,EmuteteU,WakikuyuU)
# modelled_efficacyL = c(musilongoL,KiminginiL,KezegeL,WamondoL,EmuteteL,WakikuyuL)
# col_effs = rep(c("orange","lightblue","red","darkred","blue","darkblue"),each=6)
# plot(trial_efficacy ~ modelled_efficacy,
#      col = rep(c("orange","lightblue","red","darkred","blue","darkblue"),each=6),
#      pch=19,
#      ylim = c(0,100),
#      xlim = c(0,100),
#      ylab = "Trial estimated efficacy relative to baseline",
#      xlab = "Model simulated efficacy compared to baseline")
# for(i in 1:36){
#   segments(y0 = trial_efficacy[i],
#            y1 = trial_efficacy[i],
#            x0 = modelled_efficacyU[i],
#            x1 = modelled_efficacyL[i],
#            col = col_effs[i])
# }
# 
# 
...
plot(relative_efficacy_from_t0_v1~rel_eff_mod_from_t0_v1,pch=19,col="darkorange",
     ...
     ylab="Reported change from baseline prevalence (%)",
     xlab="Simulated change from baseline prevalence (%)")
