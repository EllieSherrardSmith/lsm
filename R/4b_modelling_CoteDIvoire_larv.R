...
dat_tia = data.frame(
  ...
  lsm_mean = c(0,0,0.989,0.926),
  lsm_low = c(0,0,0.961,0.69),
  lsm_high = c(0,0,0.997,0.984)
)
...
abline(v=6.5,lty=2)
legend("topleft",legend = c("Kakologo","Nambatiourkaha"),
       col = c("aquamarine2","purple"),pch=15,bty="n")

par(xpd=NA,cex = 1.11)

text(x = -19.5, y = 1.04,"(A)",cex=0.8)
text(x = -10, y = 1.04,"(B)",cex=0.8)
text(x = -1, y = 1.04,"(C)",cex=0.8)
